...
(library Library_1
	...
	(patternDef "SHDR6W87P254_2X3_812X508X870P" (originalName "SHDR6W87P254_2X3_812X508X870P")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.72 -1.47) (pt -1.72 3.81) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.72 3.81) (pt 6.75 3.81) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6.75 3.81) (pt 6.75 -1.47) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6.75 -1.47) (pt -1.72 -1.47) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "PPTC061LFBN-RC" (originalName "PPTC061LFBN-RC") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		...
		(attr "Datasheet Link" "http://www.sullinscorp.com/drawings/78_P(N)PxCxxxLFBN-RC,_10492-H.pdf")
		(attr "Height" "8.7 mm")
	)
