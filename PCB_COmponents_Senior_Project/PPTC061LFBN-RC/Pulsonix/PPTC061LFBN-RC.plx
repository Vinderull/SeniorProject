...
//642028/67790/2.33/6/4/Connector
...
(library Library_1
	...
	(patternDef "SHDR6W87P254_2X3_812X508X870P" (originalName "SHDR6W87P254_2X3_812X508X870P")
		(multiLayer
			(pad (padNum 1) (padStyleRef s157.5_h105) (pt 0, 0) (rotation 90))
			(pad (padNum 2) (padStyleRef c157.5_h105) (pt 0, 2.54) (rotation 90))
			(pad (padNum 3) (padStyleRef c157.5_h105) (pt 2.54, 0) (rotation 90))
			(pad (padNum 4) (padStyleRef c157.5_h105) (pt 2.54, 2.54) (rotation 90))
			(pad (padNum 5) (padStyleRef c157.5_h105) (pt 5.08, 0) (rotation 90))
			(pad (padNum 6) (padStyleRef c157.5_h105) (pt 5.08, 2.54) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.97 -1.72) (pt -1.97 4.06) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.97 4.06) (pt 7 4.06) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 7 4.06) (pt 7 -1.72) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 7 -1.72) (pt -1.97 -1.72) (width 0.05))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.72 -1.47) (pt -1.72 3.81) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.72 3.81) (pt 6.75 3.81) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6.75 3.81) (pt 6.75 -1.47) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6.75 -1.47) (pt -1.72 -1.47) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0 -1.47) (pt 6.75 -1.47) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 6.75 -1.47) (pt 6.75 3.81) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 6.75 3.81) (pt -1.72 3.81) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.72 3.81) (pt -1.72 0) (width 0.2))
		)
	)
	(symbolDef "PPTC061LFBN-RC" (originalName "PPTC061LFBN-RC")
	...
	(compDef "PPTC061LFBN-RC" (originalName "PPTC061LFBN-RC") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "PPTC061LFBN-RC"))
		(attachedPattern (patternNum 1) (patternName "SHDR6W87P254_2X3_812X508X870P")
			(numPads 6)
			(padPinMap
		...
		(attr "Manufacturer_Name" "Sullins")
		(attr "Manufacturer_Part_Number" "PPTC061LFBN-RC")
		(attr "RS Part Number" "")
		(attr "RS Price/Stock" "")
		(attr "Arrow Part Number" "PPTC061LFBN-RC")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "CONN HEADER FEMALE 6POS .1" TIN")
		(attr "<Hyperlink>" "http://www.sullinscorp.com/drawings/78_P(N)PxCxxxLFBN-RC,_10492-H.pdf")
