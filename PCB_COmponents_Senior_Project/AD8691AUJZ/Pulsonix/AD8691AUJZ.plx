...
//837416/67790/2.33/5/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AD8691AUJZ" (originalName "AD8691AUJZ")
	...
	(compDef "AD8691AUJZ" (originalName "AD8691AUJZ") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AD8691AUJZ"))
		...
		(attr "Manufacturer_Part_Number" "AD8691AUJZ")
		(attr "RS Part Number" "")
		(attr "RS Price/Stock" "")
		(attr "Arrow Part Number" "AD8691AUJZ")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "ANALOG DEVICES - AD8691AUJZ - IC, OP AMP, CMOS, SMD, 8691, TSOT-5")
		(attr "<Hyperlink>" "http://www.analog.com/media/en/technical-documentation/data-sheets/AD8691_8692_8694.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "AD8691AUJZ.stp")
	)
